...
qsub -V -S /bin/bash -cwd -N no_disorder_1_1 -q jdubi.q run_RC_SET.sh 1 1 "$vmin" 2 0.01 "$vg_avg" "$vg_std" "$c_avg" "$c_std" "$cg_avg" "$cg_std" "$r_avg" 0  "$rg_avg" "$rg_std" "$repeats" "$n_avg" "$n_std" "$q_avg" "$q_std" "no_disorder_1_1" "for_weizmann" "uniform"

sleep 3

qsub -V -S /bin/bash -cwd -N r_disorder_two_points_1_1 -q jdubi.q run_RC_SET.sh 1 1 "$vmin" 2 0.01 "$vg_avg" "$vg_std" "$c_avg" "$c_std" "$cg_avg" "$cg_std" "$r_avg" 9  "$rg_avg" "$rg_std" "$repeats" "$n_avg" "$n_std" "$q_avg" "$q_std" "r_disorder_two_points_1_1" "for_weizmann" "two_points"
...
qsub -V -S /bin/bash -cwd -N r_disorder_uniform_1_10 -q jdubi.q run_RC_SET.sh 1 10 "$vmin" 20 0.01 "$vg_avg" "$vg_std" "$c_avg" "$c_std" "$cg_avg" "$cg_std" "$r_avg" 9  "$rg_avg" "$rg_std" "$repeats" "$n_avg" "$n_std" "$q_avg" "$q_std" "no_disorder_uniform_1_10" "$f" "uniform"  
...
qsub -V -S /bin/bash -cwd -N r_disorder_uniform_10_10 -q jdubi.q run_RC_SET.sh 10 10 "$vmin" 20 0.01 "$vg_avg" "$vg_std" "$c_avg" "$c_std" "$cg_avg" "$cg_std" "$r_avg" 9  "$rg_avg" "$rg_std" "$repeats" "$n_avg" "$n_std" "$q_avg" "$q_std" "no_disorder_uniform_10_10" "$f" "uniform"
